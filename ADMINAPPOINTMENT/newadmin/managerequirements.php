...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'registrar') {
		...
		<li  class="active">
			...
			<li class="dropdown">
				...
				<ul class="collapse list-unstyled menu" id="homeSubmenu1">
					<li>
						<a href="../newadmin/managesched.php">Manage Appointment</a>
					</li>
					<li>
						<a href="../newadmin/managerequirements.php">Manage Requirement</a>
					</li>
		   ...
		   <li class="">
				<a href="viewappoint.php"><i class="material-icons">date_range</i><span>View Appointment</span></a>
			</li>
		  ...
		  <!------top-navbar-end-----------> 
				  ...
				  <div class="table-title">
					<div class="row">
						<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
						   <h2 class="ml-lg-2">Manage  Requirements</h2>
						</div>
						<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
						  <a class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addTabModal" id="addTabButton">
		   ...
		   <span class="custom-checkbox">
			   ...
			   <label for="selectAll"></label>
						  ...
						  <tbody class="editbtn" id="requirements-tbody">
								   ...
								   <div class="modal-dialog" role="document">
									   <div class="modal-content">
										   <div class="modal-header">
											   <h5 class="modal-title" id="addTabModalLabel">Add Requirements</h5>
										   ...
										   <div class="modal-body">
											   <form id="addTabForm">
												   ...
												   <div id="requirements">
													   <div class="form-group">
														   <label for="requirementInput1">Requirements</label>
														   <input type="text" class="form-control" id="requirementInput1" required>
													   </div>
												   </div>
												   <button type="button" class="btn btn-secondary" id="addRequirementBtn">Add Requirements</button>
											   </form>
										   </div>
										   <div class="modal-footer">
											   <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
											   <button type="button" class="btn btn-danger" id="submitTabBtn">Submit</button>
										   </div>
									   </div>
								   </div>
							   </div>
				...
				<div class="modal" tabindex="-1" id="editModal">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<input type="text" id="editTitle" class="form-control mb-3" placeholder="Title">
								<div id="editRequirements"></div>
							</div>
							
							<button id="addEditRequirementBtn" class="btn btn-primary mt-2">Add Requirement</button>
...
<!-------complete html----------->
 ...
 <script src="manageRequirement.js"></script>
 <script src="actionRequirement.js"></script>
