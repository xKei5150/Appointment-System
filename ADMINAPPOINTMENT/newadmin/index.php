		  ...
		  <!------top-navbar-end-----------> 
				  ...
				  <div class="table-title">
					<div class="row">
						<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
						   <h2 class="ml-lg-2">Manage  Announcement</h2>
						</div>
		   ...
		   <label for="selectAll"></label></span>
						  ...
						  <tbody class="editbtn" id="announcementsContainer">
								   ...
								   <div class="modal-dialog">
									 <div class="modal-content">
									   <div class="modal-header">
										 <h5 id="announcementModalHeader">ADD ANNOUNCEMENT</h5>
								 ...
								 <div class="modal" tabindex="-1" id="addAnnouncement">
									<div class="modal-dialog">
									  <div class="modal-content">
										<div class="modal-header">
										  <h5 id="announcementHeader">ADD ANNOUNCEMENT</h5>
										  <!--<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>-->
										</div>
										  <div class="modal-body"   >
											  <form id="announcement1Form">
											  <label  for="title">Announcement Title</label>
											  <div class="form-floating">
												  <input type="text" class="form-control" id="title" name="title" placeholder="Enter Title">
												 </div>
										  ...
										  <div class="modal-footer">
											...
											<button type="submit" id="saveChangesAnn"  class="btn btn-danger">Update</button>
										</div>
										  </form>
									  </div>
								  </div>
