...
if (!isset($_SESSION['username']) || $_SESSION['usertype'] != 'deanoffice') {
...
<div class="wrapper">
	 ...
	 <nav id="sidebar">
		<div class="sidebar-header">
			<h3><img src="../newadmin/logo.png.png" class="img-fluid"/><span>Dean Office</span></h3>
		</div>
		...
		<li  class="active">
			...
			<li class="dropdown">
				...
				<ul class="collapse list-unstyled menu" id="homeSubmenu1">
					<li>
						<a href="../deanoffice/managesched.php">Manage Schedule</a>
					</li>
		   ...
		   <li class="">
				<a href="../deanoffice/viewappoint.php"><i class="material-icons">date_range</i><span>View Appointment</span></a>
			</li>
							  ...
							  <ul class="nav navbar-nav flex-row ml-auto">
							   ...
							   <li class="dropdown nav-item">
								 ...
								 <ul class="dropdown-menu small-menu">
									<li><a href="../deanoffice/editprofile.php">
									<span class="material-icons">person_outline</span>
									Profile
									</a></li>
									<li><a href="../deanoffice/setting.php">
