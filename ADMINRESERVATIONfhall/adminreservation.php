		...
		<li  class="active">
			...
			<li class="dropdown">
				...
				<ul class="collapse list-unstyled menu" id="homeSubmenu1">
					<li>
						<a href="../ADMINRESERVATIONfhall/ManageSched.html">Manage Date/Slot</a>
					</li>
					<li>
						<a href="../ADMINRESERVATIONfhall/managereminders.html">Manage Requirement</a>
					</li>
							   ...
							   <li class="dropdown nav-item">
							     <a class="nav-link" href="#" data-toggle="dropdown">
								  ...
								  <ul class="dropdown-menu small-menu">
								     <li><a href="../ADMINRESERVATIONfhall/editprofile2.html">
